...
# async def get_info_user(api, username, days=0, weeks=0, months=0, data_path=None):
#     """Crawl user info and videos. Optionally save data if `save=True`."""
#     user_path = os.path.join(
#         data_path, username) if data_path else None  # Set user path ONCE
#     user_info, videos, missing_videos = {}, [], []

#     try:
#         # Check if data already exists
#         user_info_path = os.path.join(
#             user_path, "user_info.json") if user_path else None
#         videos_info_path = os.path.join(
#             user_path, "videos_info.json") if user_path else None
#         missing_videos_path = os.path.join(
#             user_path, "missing_videos.json") if user_path else None

#         if user_path and os.path.exists(user_info_path) and os.path.exists(videos_info_path):
...
#         if result is None:
#             # print(f"🚫 Unable to retrieve videos for @{username}. Skipping...")
#             # Indicate failure
...
#                 tasks = [get_info_user(
#                     api, user, days, weeks, months, data_path) for user in user_batch]
...
#     if data_path and missing_users:
...
#     else:
#         print(
#             f"\n✅ All users processed successfully, after {attempt} attemps!")
...
# async def get_videos_for_hashtags(hashtags, count=1000, data_path=None):
